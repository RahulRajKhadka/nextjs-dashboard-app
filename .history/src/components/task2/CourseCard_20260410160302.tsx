...
export default function CourseCard({
  ...
  return (
    ...
    >
      ...
      {/* ========== EXPANDED STATE: Number at bottom-left (handled by GSAP) ========== */}
      {isExpanded && (
        <>
          {/* Number moves to bottom-left during animation */}
          ...
          {/* Label animates to beside number */}
          <div
            ref={collapsedLabelRef}
