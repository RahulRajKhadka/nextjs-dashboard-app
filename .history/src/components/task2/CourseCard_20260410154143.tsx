...
export default function CourseCard({
  ...
  return (
    ...
    >
      ...
      />
<div className="absolute inset-0 z-[3] flex flex-col items-center justify-center pointer-events-none bg-red-500/50">
  {/* Red background to see the container */}
  
  {/* LABEL (top) */}
  <div className="flex flex-col gap-1 mb-6 bg-green-500/50 p-2">
    <span className="font-bold text-[20px] whitespace-nowrap text-black">
      TEST LABEL
    </span>
    <p className="text-[15px] opacity-60 whitespace-nowrap text-black">
      TEST SUBLABEL
    </p>
  </div>
  
  {/* NUMBER (bottom) */}
  <div className="flex items-end bg-blue-500/50 p-2">
    <span className="font-black leading-none text-black text-5xl">
      01
    </span>
    <span className="font-black text-3xl mb-2 ml-1 text-black">
      +
    </span>
  </div>
</div>
