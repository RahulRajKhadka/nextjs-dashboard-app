...
export default function CourseCard({
  ...
  return (
    ...
    >
      ...
      />
{/* COLLAPSED STATE - Stacked vertically in center */}
{!isExpanded && (
  <div className="absolute inset-0 z-[3] flex flex-col items-center justify-center pointer-events-none">
    
    {/* LABEL (top) - WITHOUT rotation for now to test */}
    <div 
      ref={collapsedLabelRef}
      className="flex flex-col gap-1 mb-8 text-center"
      style={{ 
        // Remove rotation temporarily - add back after flex works
