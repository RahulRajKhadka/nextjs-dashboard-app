...
export default function CourseCards() {
  ...
  return (
    <div ref={containerRef} className="flex  gap-4 box-border w-full my-8 bg-blue-500  min-h-[200px] md:min-h-[200px] lg:min-h-[400px] ">
      {courseCardsData.map((course, i) => (
        ...
        >
          <CourseCard
            ...
            labelRef={(el:any) => { labelRefs.current[i] = el; }}
            numberRef={(el:any) => { numberRefs.current[i] = el; }}
          />
        </div>
      ))}
    </div>
