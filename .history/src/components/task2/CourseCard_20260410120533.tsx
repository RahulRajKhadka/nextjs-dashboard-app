...
useLayoutEffect(() => {
  ...
  if (isExpanded) {
    // ──────────────────────────────────────────────
    // Measure positions FIRST (while expanded view is hidden)
    // ──────────────────────────────────────────────
    ...
    // ──────────────────────────────────────────────
    // Label animates FIRST (expanded view stays HIDDEN)
    // ──────────────────────────────────────────────
    gsap.to(collapsedLabelRef.current, {
      ...
      ease: "power2.inOut",
      onComplete: () => {
        // ✅ ONLY AFTER label animation completes, show expanded view
        gsap.set(expandedViewRef.current, { display: "grid" });
        
        // Then animate topbar and icons
    ...
    // Collapse - hide expanded view FIRST
    gsap.set(expandedViewRef.current, { display: "none" });
