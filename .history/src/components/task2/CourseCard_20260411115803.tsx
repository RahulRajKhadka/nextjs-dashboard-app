...
{/* Label - absolute top */}
<div className="absolute top-0 left-0 right-0 z-[3] flex justify-center pt-6 pointer-events-none">
  <div
...
{/* Number - absolute bottom */}
<div
  ref={numberRef}
  className="absolute bottom-0 left-0 z-[3] pb-6 pl-6 pointer-events-none"
