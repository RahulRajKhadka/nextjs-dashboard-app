...
export default function CourseCard({
  ...
  return (
    ...
    >
      ...
      {/* COLLAPSED CONTENT: flex column with label at top, number at bottom (justify-between) */}
      <div className="absolute inset-0 z-[3] flex flex-col  justify-between pointer-events-none">
        {/* Rotated label */}
        <div
          ref={collapsedLabelRef}
          className="flex flex-col gap-1 mt-6"   // added mt-6 for a little top spacing (optional)
        ...
        {/* Number at bottom (flex-end) */}
        <div ref={numberRef} className="mb-6" style={{ color: course.textColor }}>
