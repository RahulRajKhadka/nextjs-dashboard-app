...
export default function CourseCard({
  ...
  {/* COLLAPSED CONTENT - No space between, number at bottom */}
<div className="absolute inset-0 z-[3] flex flex-col items-center pointer-events-none">
  ...
  {/* Number at bottom (pushed by mt-auto) */}
  <div ref={numberRef} className="mt-auto mb-6" style={{ color: course.textColor }}>
