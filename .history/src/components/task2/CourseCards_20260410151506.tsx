...
export default function CourseCards() {
  ...
  return (
    <div ref={containerRef} className="flex items-center gap-4 box-border w-full py-8 bg-blue-500  min-h-[200px] md:min-h-[200px] lg:min-h-[400px] ">
      {courseCardsData.map((course, i) => (
        <div
          ...
          className="shrink-0 overflow-hidden my-8 rounded-3xl"
        >
          <CourseCard
            course={course}
